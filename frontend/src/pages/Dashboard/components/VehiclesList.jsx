    ...
    <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100">
      ...
      {vehicles.length > 0 ? (
        ...
        <div className="px-6 py-12 text-center">
          ...
          {isAdmin && (
            <Link to="/vehicles/new" className="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700">
              Araç Ekle
            </Link>
          )}
        </div>
